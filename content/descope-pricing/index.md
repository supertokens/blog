...
- Only 5 test users &mdash; not viable for staging environments
- SLA capped at 99%

### Pro &mdash; $249/month (billed annually)

The Pro plan adds more breathing room: 10K MAUs, 35 tenants, 5 SSO, and 2 federated apps.
...
However, beware that this plan **still lacks bot protection, SCIM, and support for anonymous users**. If you need any of those, you’ll be bumped to Growth &mdash; even if you don’t exceed your MAU limits.

### Growth &mdash; $799/month (billed annually)

Designed for apps in active growth, the Growth tier expands to 25K MAUs, 100 tenants, and 10 SSO connections &mdash; with the same overage pricing as Pro.
...
Beyond Growth, Descope moves into custom contracts. The core features stay the same, but limits are lifted &mdash; including unlimited test users, unlimited anonymous users, and access to a dedicated CS engineer.
...
Descope’s pricing looks simple on the surface &mdash; but real usage scenarios reveal how overages and feature gates can shape your total cost. Below are a few common patterns.
...
Then let’s say you also add 3 more SSO connections, bringing the total to 6. Since the Pro plan includes 5 SSO connections, you’ll pay overage for just one. So the cost jumps to:
...
## How Descope Pricing Compares to Auth0 & Okta
...
Unlike Descope, SuperTokens doesn’t gate critical features like MFA, RBAC, or SSO behind higher tiers. Everything is available out of the box, even on self-hosted deployments &mdash; so teams don’t have to upgrade just to unlock essentials.

### Superior support & SLA options
...
> “the best thing about Descope is their customer support - they are incredibly helpful and responsive, and even offered to get on Zoom calls to help me debug some of my issues (and I'm on their free tier!)” &mdash; *Founding Engineer, G2*
...
Ready to take control of your authentication stack? Explore [SuperTokens](https://supertokens.com/pricing). You can self host for free or scale easily using the managed service. Transparent pricing, no feature gates, and no surprises.